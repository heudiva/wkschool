                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        ...
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            ...
                                            <div class="text-sm font-normal text-gray-500 dark:text-gray-400 capitalize">{{ $student->gender }}</div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                                        @if($student->address)
                                            {{ $student->address->village ?? 'N/A' }}, {{ $student->address->commune ?? 'N/A' }}, {{ $student->address->district ?? 'N/A' }}, {{ $student->address->province ?? 'N/A' }}
                                        @else
                                            No address provided
                                        @endif
                                    </td>
                                    ...
                                    <td class="p-4 space-x-2 text-center whitespace-nowrap">
                                        <button id="EditstudentBtn" value="{{ $student->id }}" type="button" data-modal-target="edit-student-modal" data-modal-toggle="edit-student-modal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
